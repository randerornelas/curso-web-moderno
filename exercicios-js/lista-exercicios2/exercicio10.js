...
function despesasTotais(arr) {
    const totalPrecos = arr.reduce((acumulador, valorAtual) => acumulador + valorAtual.preco, 0)
...
console.log(despesasTotais(despesas1)) // retornará 239.99

console.log(despesasTotais(despesas2)) // retornará 34599.89